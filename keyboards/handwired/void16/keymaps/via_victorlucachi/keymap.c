...
[_BASE] = LAYOUT_ortho_4x4(
    ...
    MO(_FN3),   RGUI(KC_PGUP),      RGUI(KC_HOME),      KC_TRNS,
    MO(_FN1),   LCTL(LSFT(KC_3)),   LCTL(LSFT(KC_4)),   KC_MYCM,
    MO(_FN2),   RGUI(KC_INS),       RGUI(KC_PGDN),      KC_F14
),
...
[_FN3] = LAYOUT_ortho_4x4(
    ...
    KC_TRNS,   LCTL(LSFT(LALT(KC_P))),    LCTL(LSFT(LALT(KC_R))),   KC_ESC,
    KC_TRNS,   KC_TRNS,                   KC_TRNS,                  KC_TRNS,
    KC_TRNS,   KC_TRNS,                   KC_TRNS,                  KC_TRNS
)
};
